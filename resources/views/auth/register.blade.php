    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4" x-data="{ showPassword: false }">
            ...
            <div class="relative mt-1">
                ...
                <!-- Tombol Ikon Mata Password -->
                <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 focus:outline-none">
                    <!-- Ikon Mata Terbuka -->
        ...
        <div class="mt-4" x-data="{ showConfirmPassword: false }">
            ...
            <div class="relative mt-1">
                ...
                <!-- Tombol Ikon Mata Confirm Password -->
                <button type="button" @click="showConfirmPassword = !showConfirmPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 focus:outline-none">
                    <!-- Ikon Mata Terbuka -->
